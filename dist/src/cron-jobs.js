...
function startAllCronJobs(bot) {
    ...
    deleteExpiredJob = node_cron_1.default.schedule('0 11 * * *', () => asyncDeleteExpiredUsers(bot));
    // Every day at 09:00 notify users with expiring access
    notifyJob = node_cron_1.default.schedule('05 11 * * *', () => asyncNotifyJob(bot));
    // Every Monday, Wednesday, and Friday at 10:00 send motivation message
    motivationJob = node_cron_1.default.schedule('06 11 * * 1,3,5', () => asyncMotivationJob(bot));
